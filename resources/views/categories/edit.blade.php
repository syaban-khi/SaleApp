                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @endif
                                <form action="{{ route('categories.update', $categories->categoryID) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="category_name" id="category_name" class="form-control" value="{{ old('category_name', $categories->category_name) }}" required>
                                            </div>
                                        </div>
                                    </div>
