                    ...
                    <div class="page-block">
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('categories.index') }}"><i class="feather icon-layers"></i></a></li>
                        ...
                        <div class="card">
                            ...
                            <div class="d-flex justify-content-between mb-3">
                                <div>
                                    ...
                                    <a href="{{ route('categories.print') }}" class="btn btn-secondary btn-sm">🖨 Print</a>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        @foreach ($categories as $category)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('categories.edit', $category->categoryID) }}" class="btn btn-warning btn-sm" title="Edit">
                                                        <i class="feather icon-edit"></i>
                                                    </a>
                                                    <form action="{{ route('categories.destroy', $category->categoryID) }}" method="POST" style="display:inline-block;">
                                                        @csrf
                                                        @method('DELETE')
