                    ...
                    <div class="page-block">
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('saleUser.index') }}"><i class="feather icon-file-text"></i></a></li>
                                    <li class="breadcrumb-item">Transaction</a></li>
                                    <li class="breadcrumb-item">Sale List</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="d-flex justify-content-between mb-3">
                                <a href="{{ route('saleUser.create') }}" class="btn btn-primary btn-sm">+ Create</a>
                            </div>
                            <form action="{{ route('saleUser.index') }}" method="GET">
                                <div class="row">
                                    <div class="col-sm-12">
                                    ...
                                    <tbody>
                                        @foreach ($sales as $sale)
                                            <tr>
                                                ...
                                                <td>{{ $sale->customer ? $sale->customer->customer_name : 'General Customer' }}</td>
                                                <td>Rp {{ number_format($sale->total_amount, 2) }}</td>
                                                <td>
                                                    <a href="{{ route('saleUser.show', $sale->saleID) }}" class="btn btn-warning btn-sm" title="Detail">
