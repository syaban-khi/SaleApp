                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">Supplier Edit</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @endif
                                <form action="{{ route('suppliers.update', $suppliers->supplierID) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="supplier_name" id="supplier_name" class="form-control" value="{{ old('supplier_name', $suppliers->supplier_name) }}" required>
                                            </div>
                                        </div>
                                    </div>
