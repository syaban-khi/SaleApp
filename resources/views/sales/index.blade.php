                        ...
                        <div class="card">
                            ...
                            <div class="d-flex justify-content-between mb-3">
                                <div>
                                    ...
                                    <a href="{{ route('sales.print') }}" class="btn btn-secondary btn-sm">🖨 Print</a>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        @foreach ($sales as $sale)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('sales.show', $sale->saleID) }}" class="btn btn-warning btn-sm" title="Detail">
                                                        <i class="feather icon-info"></i>
                                                    </a>
                                                    <form action="{{ route('sales.destroy', $sale->saleID) }}" method="POST" style="display:inline-block;">
                                                        @csrf
                                                        @method('DELETE')
