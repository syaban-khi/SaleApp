                    ...
                    <div class="page-block">
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('products.index') }}"><i class="feather icon-box"></i></a></li>
                                    <li class="breadcrumb-item">Product</a></li>
                                    <li class="breadcrumb-item">Product List</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="d-flex justify-content-between mb-3">
                                <div>
                                    ...
                                    <a href="{{ route('products.print') }}" class="btn btn-secondary btn-sm">🖨 Print</a>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        @foreach ($products as $product)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('products.edit', $product->productID) }}" class="btn btn-warning btn-sm" title="Edit">
