                            ...
                            <div class="card-body">
                                ...
                                @if($shops)
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="profile-img">
                                                @if($shops->logo)
                                                    <img src="{{ asset('assets/images/' . $shops->logo) }}" alt="Shop Logo" class="img-fluid rounded-circle" style="width: 250px; height: 250px; margin-left: 100px;">
                                                @else
                                    ...
                                    <div class="text-right">
                                        <a href="{{ route('shops.edit', $shops->shopID) }}" class="btn btn-primary">Edit</a>
                                    </div>
                                    <hr>
                                @else
                                    <h3>Tambah Profil Toko</h3>
