                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title">
                                    <h5 class="m-b-10">Sale Report</h5>
                                </div>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('reportSale') }}"><i class="fa fa-print"></i></a></li>
                                    <li class="breadcrumb-item">Sale Report</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <form action="" method="GET">
                                    ...
                                    <div class="text-right">
                                        <a href="{{ route('sale.download-pdf') }}" target="_blank" class="btn btn-primary btn-sm" style="background-color:rgb(13, 206, 164); color: white; padding: 10px 20px; border-radius: 4px;">
