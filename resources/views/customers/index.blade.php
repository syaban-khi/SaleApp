                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">Customer</a></li>
                                    <li class="breadcrumb-item">Customer List</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="d-flex justify-content-between mb-3">
                                <div>
                                    ...
                                    <a href="{{ route('customers.print') }}" class="btn btn-secondary btn-sm">🖨 Print</a>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        @foreach ($customers as $customer)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('customers.edit', $customer->customerID) }}" class="btn btn-warning btn-sm" title="Edit">
